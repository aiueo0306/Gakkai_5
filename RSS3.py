...
def extract_items(page):
    ...
    page.wait_for_selector("div.news-articles div.body", timeout=10000) 
    
    selector = "div.news-articles div.body"
    ...
    for i in range(min(count, max_items)):
        try:
            ...
            title = block.locator("br").first.inner_text().strip()
